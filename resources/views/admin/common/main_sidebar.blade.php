        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                <div class="sidebar-user-avatar">
                    <a href="page_ready_user_profile.php">
                        <img src="{!! asset('public/tenant_template_assets/img/placeholders/avatars/avatar2.jpg') !!}" alt="avatar">
                    </a>
                </div>
                <div class="sidebar-user-name">Brice Hache</div>
           ...
           {{-- <ul class="sidebar-section sidebar-themes clearfix sidebar-nav-mini-hide">--}}
            ...
            <ul class="sidebar-nav">
                <li>
                    <a href="{{route('admin.dashboard')}}" class="{{ Request::url() === url('/admin') ? ' active' : '' }}"><i class="gi gi-dashboard sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">{{__('admin.Dashboard')}}</span></a>
                </li>

                <li class="sidebar-header">
                    <span class="sidebar-header-options clearfix"><a href="javascript:void(0)" data-toggle="tooltip" title="{{__('admin.usersManagement')}}"><i class="gi gi-user"></i></a></span>
                    <span class="sidebar-header-title">{{__('admin.usersManagement')}}</span>
                </li>
                <li class=" {!! (Request::is('admin/users') || Request::is('admin/bulk_import_users') || Request::is('admin/users/create') || Request::is('admin/user_profile') || Request::is('admin/users/*') || Request::is('admin/deleted_users') ? ' active' : '' ) !!}">
                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-double-right sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-users sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">{{ __('admin.users') }}</span></a>
                    <ul>
                        <li>
                            <a href="{{ URL::to('admin/users') }}" {!! (Request::is('admin/users') ? 'class="active" id="active"' : '' ) !!}>{{ __('admin.users') }}</a>
                        </li>
                        <li>
                            <a href="{{ URL::to('admin/users/create') }}" {!! (Request::is('admin/users/create') ? 'class="active" id="active"' : '' ) !!}>{{ __('admin.addNewUser') }}</a>
                        </li>
                        <li>
                            <a href="{{ URL::to('admin/deleted_users') }}" {!! (Request::is('admin/deleted_users') ? 'class="active" id="active"' : '' ) !!}>{{ __('admin.deleteUsers') }}</a>
                        </li>
                ...
                <li class="sidebar-header">
                    <span class="sidebar-header-options clearfix"><a href="javascript:void(0)" data-toggle="tooltip" title="{{__('admin.Generalsettings')}}"><i class="gi gi-settings"></i></a></span>
                    <span class="sidebar-header-title">{{__('admin.Generalsettings')}}</span>
                </li>
                <li>
                    <a href="{{route('admin.template_settings.index')}}" class="{{ Request::is('/template_settings') ? ' active' : '' }}"><i class="gi gi-settings sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">{{__('admin.Backendsettings')}}</span></a>
                </li>
                <li>
                    <a href="{{route('admin.template_settings.index')}}" class="{{ Request::is('admin/template_settings') ? ' active' : '' }}"><i class="gi gi-embed_close"></i><i class="gi gi-settings sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">{{__('admin.Templatesettings')}}</span></a>
                </li>
               {{-- <li>
