...
class UsersController extends BriceHacheController
{
    ...
    public function index()
    {
        ...
        // Show the page
        return view('admin.users.index', compact('users'))->with('result', $result);
    }
    ...
    public function data()
    {
        ...
        return DataTables::of($users)
            ...
            ->addColumn(
                'actions',
                function ($user) {
                    $actions = '<a href='. route('admin.users.show', $user->id) .' data-toggle="tooltip" class="btn btn-xs btn-primary" data-original-title="Voir"><i class="gi gi-eye_open" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="Voir"></i></a> &nbsp;
                            <a href='. route('admin.users.edit', $user->id) .' data-toggle="tooltip" class="btn btn-xs btn-success" data-original-title="Modifier"><i class="gi gi-pencil" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="modifier"></i></a>&nbsp;';
                    /*if ((Sentinel::getUser()->id != $user->id) && ($user->id >2)) {*/
                    if ((Sentinel::getUser()->id != $user->id)) {
                        $actions .= '<a href='. route('admin.users.confirm-delete', $user->id) .' data-id="'.$user->id.'" data-toggle="modal" data-target="#delete_confirm" class="btn btn-xs btn-danger" data-original-title="Supprimer"><i class="gi gi-bin" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="Supprimer"></i></a>';
                    }
                    return $actions;
                }
            )
